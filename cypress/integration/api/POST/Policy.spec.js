...
const payloadFormulaValidator = require("../../../fixtures/api/Policy/postFormulaValidator.json");
const payloadPolicy = require("../../../fixtures/api/Policy/postPolicy.json");
const payloadImport = require("../../../fixtures/api/Policy/postImport.json");
const payloadExport = require("../../../fixtures/api/Policy/postExport.json");
